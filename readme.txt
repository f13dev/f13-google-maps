...
If you own a shop, host events, or have any other need to add a google map reference to your WordPress blog, try F13 Google Maps Shortcode.
...
1. The results of adding [googlemap building="Harrods" town="London"] to a blog post.
